...
PRO HFI_plot, x, y, _EXTRA=_EXTRA, DECMODX=DECMODX, DECMODY=DECMODY, $
  Y_DX=Y_DX, Y_DY=Y_DY, X_DX=X_DX, X_DY=X_DY, charsize=charsize,$
...
PRO LS_diamond, SZ=SZ, TK=TK, FILL=FILL,color=color
  ;
  ; This routine allows a circle to be plotted using the IDL user-selected PSYM (PSYM=8)
  ; It can be filled or open.
  ;
...
;;               STAGGER=stagger, AZEQ=azeq, JPEG=jpeg, keep_file_open=keep_file_open,$
...
;
; -----------------------------------------------------------------------------
pro hfils_mollview, file_in, select_in, $
              ASINH = asinh, $
              CHARSIZE = charsize, $
              CHARTHICK = charthick, $
              COLT = colt, $
