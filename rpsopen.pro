;+
; NAME:
;RPSOPEN -- open the PostScript device for outputting graphics to a file.
;     
; PURPOSE:
;       To open the PostScript device for outputting graphics to a file.
;     
;CALLING SEQUENCE:
;      RPSOPEN, FILENAME [, /LANDSCAPE] [, XSIZE=width] [, YSIZE=height] [,
...
;
; RESTRICTIONS:
;       RPSOPEN assumes letter-sized pages.
;       RPSOPEN sets the graphics device to PostScript and leaves a
...
;       PSCLOSE will do all of thiss for you.
;
; EXAMPLE:
